  ...
  return (
    <div className="bg-[#faeee7] pt-4">
      ...
      <section className="bg-zinc-50 p-6 pb-10 flex flex-col items-center justify-center">
        <p className="text-[#594a4e] my-2 text-3xl font-bold text-center">{servicio}</p>
        <div className="bg-[#faeee7] flex flex-col items-center justify-center p-6">
          ...
          <div className="flex flex-row rounded-full p-2 bg-[#594a4e] text-zinc-50 shadow-md items-center">
            <IconHeartFilled color={"#e1306c"} />
